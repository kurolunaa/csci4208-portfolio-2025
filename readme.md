...
| Lab-04 — JavaScript Basics: Hi–Lo Game (MVP → MVC) [#6](https://github.com/kurolunaa/csci4208-portfolio-2025/issues/6) | `lab-04` | closed |
| Lab-05 — JavaScript OOP + Phaser: Dodger Game [#7](https://github.com/kurolunaa/csci4208-portfolio-2025/issues/7) | `lab-05` | closed |
| Project-0 — Set up Repo, Project Board, Actions & Pages [#8](https://github.com/kurolunaa/csci4208-portfolio-2025/issues/8) | `project-00` | open |
